...
6. [Day 6：第一个 ROS 2 包](day-13-ros2-workspace.md)
7. [Day 7：Topic 与消息契约](day-14-ros2-topics.md)
8. [Day 8：把感知逻辑接入 ROS 2](day-15-perception-node.md)
9. [Day 9：参数与 Launch](day-16-parameters-launch.md)
10. [Day 10：可回放的离线感知系统](day-18-rosbag-integration.md)
...
11. [Day 11：导出 ONNX](day-07-onnx-export.md)
12. [Day 12：ONNX Runtime 基线](day-08-onnx-runtime.md)
13. [Day 13：在目标 Jetson 构建 TensorRT Engine](day-09-tensorrt-build.md)
14. [Day 14：三后端公平性能与内存基准](day-10-backend-benchmark.md)
15. [Day 15：部署选择与接口冻结](day-12-deployment-review.md)
...
16. [Day 16：坐标变换的数学基础](day-19-coordinate-math.md)
17. [Day 17：相机模型、深度与三维点](day-17-camera-geometry.md)
18. [Day 18：把坐标关系放入 TF2](day-20-tf2.md)
19. [Day 19：用 URDF/Xacro 描述机械臂](day-21-urdf.md)
20. [Day 20：MoveIt 2 仿真配置](day-22-moveit-setup.md)
...
21. [Day 21：规划一个合法目标](day-23-motion-planning.md)
22. [Day 22：让非法目标被拒绝](day-24-safety-rejection.md)
23. [Day 23：任务 Schema 与技能白名单](day-25-task-schema.md)
24. [Day 24：确定性任务状态机](day-26-state-machine.md)
25. [Day 25：感知结果成为候选任务目标](day-27-perception-to-task.md)
...
27. [Day 27：第一次端到端闭环](day-28-end-to-end.md)
28. [Day 28：失败案例是安全功能](day-29-failure-cases.md)
29. [Day 29：可观测性、指标与项目复现](day-28-observability.md)
...
- [视觉流水线的性能与可靠性](day-06-vision-review.md)
- [部署失败不应悄悄发生](day-11-reliability.md)
- [ROS 2 Service 与 Action](day-17-services-actions.md)
