...
const weeks = [
  ...
  },
  {
    ...
    days: [
      ['Day 6', '第一个 ROS 2 包', '创建、构建并运行第一个包'],
      ['Day 7', 'Topic 与消息契约', '让节点稳定发布与订阅结构化消息'],
      ['Day 8', '把离线感知接入 ROS 2', '把图像处理封装成 ROS 节点'],
      ['Day 9', '参数、YAML 与 Launch', '让节点可配置、可启动、可排查'],
      ['Day 10', '可回放的离线感知系统', '录制、回放与复现实验输入'],
    ],
  },
  {
