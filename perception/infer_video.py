...
def main() -> None:
    ...
    summary = {"input": str(args.input), "output": str(args.output), "input_fps": fps, "frames": frame_index, "duration_s": duration, "inference_every_n_frames": args.every, "inference_count": inference_count, "wall_time_s": time.perf_counter() - run_started}
